import { askForString, askForOptionalString, AskForStringOptions, ValidateFunction } from '../../lib/user-query.js'
import { InputDefinition, InputDefinitionValidateFunction, Uneditable, uneditable } from '../../lib/item-input/defs.js'
