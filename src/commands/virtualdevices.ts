...
const builder = (yargs: Argv): Argv<CommandArgs> =>
	outputItemOrListBuilder(apiCommandBuilder(yargs))
		...
		.example([
			...
			[
				'$0 virtualdevices 1',
				'display details for the first virtualdevices in the list retrieved by running ' +
					'"smartthings virtualdevices"',
			],
			[
				'$0 virtualdevices 5dfd6626-ab1d-42da-bb76-90def3153998',
				'display details for an virtualdevices by id',
			],
			[
				'$0 virtualdevices --location c822dcee-bb9f-41b8-915b-6406e5676845',
				'list all virtualdevices in the specified location',
			],
		])
